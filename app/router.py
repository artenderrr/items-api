...
ValidItemID = Annotated[int, Path(gt=0)]
...
def create_item(item_id: ValidItemID, item: Item) -> Item:
...
def update_item(item_id: ValidItemID, updated_item_fields: UpdatedItemFields) -> Item:
